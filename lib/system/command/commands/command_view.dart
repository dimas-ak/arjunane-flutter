...
class CommandsView extends Command {
  ...
  String setFileView(String fileName, int innerFolders, String fileNameController) {
    ...
    coding += '  $finalFileName${CommandsConfig.insertClassNameLast ? "View" : ""} ($finalFileNameController${CommandsConfig.insertClassNameLast ? "Controller" : ""} widget) : super(widget);\n\n';
