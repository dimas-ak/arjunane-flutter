...
class CommandsViewExtends extends Command {
  ...
  String setFileView(String fileName, int innerFolders, String fileNameView) {
    ...
    coding += '  $finalFileName${CommandsConfig.insertClassNameLast ? "ViewExtends" : ""} ($finalFileNameView${CommandsConfig.insertClassNameLast ? "View" : ""} childWidget) : super(childWidget);\n\n';

    coding += '  @override\n';
    coding += '  Widget build(BuildContext context) {\n\n';
    
    coding += "  var parent = childWidget.widget;\n\n";
